...
alias up='cd ~/.dotfiles && rake sync && prevd'
alias backup='cd ~/.dotfiles && rake backup && prevd'
...
alias dotbot='cd ~/.dotfiles && ./dotbot_install && prevd'
alias dotup='cd ~/.dotfiles && git submodule update --remote dotbot && prevd'
